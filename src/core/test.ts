export const plainText = `貴方はなんのためにゲームをしますか？
...
　妙に凝った設定のせいでラスボスにそれまでの武器が通用しないという最高にクソな要素を克服するために習得した格闘スキル「断罪飛び蹴りパニッシュメントドロップ」が少女の顔面に命中し、少女……このゲームにおけるヒロインクソビッチ「フェアリア」が錐揉み回転しながら吹き飛ぶ。
...
やけに壮大な曲と共に流れる戦犯リストエンドロールを流し見ながら、口ではそう言いつつも俺は確かな達成感に浸るのだった。`